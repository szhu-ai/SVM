function [ bac_raw, weight_raw, bac_perm_label, weight_perm_label, bac_perm_trial, weight_perm_trial, C_cv] = svm_main(s1,s2,norm_type,ratio_train_val,ncv,nfold,permute_label,permute_trial,nperm,C_range)
